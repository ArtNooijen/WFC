# small changes
i want to change the non combat encounters a little for example if you have  ![alt text](image.png) thenon easy - hard it should display the saves needed to pass the encounter and the rewards for passing it. etc.
